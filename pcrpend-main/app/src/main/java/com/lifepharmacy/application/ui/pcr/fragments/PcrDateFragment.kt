...
import com.lifepharmacy.application.ui.prescription.fragments.ClickPrescriptionWithoutFragment
...
class PcrDateFragment : BaseFragment<FragmentPcrDateBinding>(),
  ClickPcrAddressFragment, ClickTool, ClickItemImage, ClickContactLayout,
